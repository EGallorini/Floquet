...
\begin{tikzpicture}[]
  ...
  \node (origin) at (-0.15,-1)   { \includegraphics[trim={0 9cm 0 13cm},clip,width=0.5\textwidth]{AR3Re150.png}};
  \node (origin) at (0.3,0)   { $Re=150$};    
  
   \node (origin) at (6,-1)   { \includegraphics[trim={0 9cm 0 13cm},clip,width=0.5\textwidth]{AR3Re200.png}};
  \node (origin) at (6.45,0)   { $Re=200$};  
  
  \node (origin) at (-0.15,-3)   { \includegraphics[trim={0 9cm 0 13cm},clip,width=0.5\textwidth]{AR3Re250.png}};
  \node (origin) at (0.3,-2)   { $Re=250$};    
  
   \node (origin) at (6,-3)   { \includegraphics[trim={0 9cm 0 13cm},clip,width=0.5\textwidth]{AR3Re300.png}};
  \node (origin) at (6.45,-2)   { $Re=300$};    
  
  \node (origin) at (-0.15,-5)   { \includegraphics[trim={0 9cm 0 13cm},clip,width=0.5\textwidth]{AR3Re350.png}};
  \node (origin) at (0.3,-4)   { $Re=350$};    
  
   \node (origin) at (6,-5)   { \includegraphics[trim={0 9cm 0 13cm},clip,width=0.5\textwidth]{AR3Re400.png}};
